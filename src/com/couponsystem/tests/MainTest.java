...
public class MainTest
    {
         ...
         * @throws CouponSystemException CouponSystemException
         */
        private static void initFacades(CouponSystem couponSys) throws CouponSystemException
            {
                // *************************************
                System.out.println("*********************************" + "******************************************"
                        + "**************************");
                ...
                Coupon randomCoupon = new Coupon(7, "CinemaCity", Date.valueOf("2016-1-1"), Date.valueOf("2017-1-1"), 300,
                ...
                Coupon noCouponsLeft = new Coupon(9, "Bed & Breakfast", Date.valueOf("2016-1-1"), Date.valueOf("2017-1-1"), 300,
                        CouponType.TRAVELLING, "random coupon message", 149.99, "pathToImage/image.jpeg");
                Coupon newCoupon1 = new Coupon(10, "Casino Trip", Date.valueOf("2016-1-1"), Date.valueOf("2017-1-1"), 300,
                        CouponType.TRAVELLING, "random coupon message", 149.99, "pathToImage/image.jpeg");
                Coupon newCoupon2 = new Coupon(11, "Discover Cambodia", Date.valueOf("2016-1-1"), Date.valueOf("2017-1-1"), 300,
                        CouponType.TRAVELLING, "random coupon message", 149.99, "pathToImage/image.jpeg");
...
//			System.out.println(companyTest.getCouponsOfCompany());
                ...
                try
                    {
                        homeTheater = new Coupon(12, "Home Theater", Date.valueOf("2016-1-1"), Date.valueOf("2017-1-1"), 120,
                                CouponType.ELECTRICITY, "random coupon message", 229.99, "pathToImage/image.jpeg");
                        michelinDinner = new Coupon(13, "Michelin Dinner", Date.valueOf("2016-1-1"), Date.valueOf("2017-1-1"),
                                30, CouponType.RESTAURANT, "random coupon message", 299.99, "pathToImage/image.jpeg");
                        seasonTeamTickets = new Coupon(14, "Season Team Tickets", Date.valueOf("2016-1-1"), Date.valueOf("2017-1-1"),
                                30, CouponType.SPORTS, "random coupon message", 999.99, "pathToImage/image.jpeg");
                    }
                catch (Exception e)
                    {
                        e.printStackTrace();
        ...
        private static void InitiateCouponDAO() throws DAOException, CouponSystemException
            {
                ...
                Coupon electricy = new Coupon(3, "Electricity", Date.valueOf("2016-1-1"), Date.valueOf("2017-1-1"),
                ...
                Coupon Homedesign = new Coupon(5, "Homedesign", Date.valueOf("2016-1-1"), Date.valueOf("2017-1-1"),
